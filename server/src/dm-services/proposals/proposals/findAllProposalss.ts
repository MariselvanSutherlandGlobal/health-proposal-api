...
export class findAllProposalss {
  ...
  private constructor(
    ...
    this.serviceName = 'findAllProposalss';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new findAllProposalss(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_findAllProposalss_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findAllProposalss');
    //appendnew_flow_findAllProposalss_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findAllProposalss');

    this.app['post'](
      `${this.serviceBasePath}/dm/proposals/proposals/find-all`,
      cookieParser(),
    ...
    //appendnew_flow_findAllProposalss_HttpIn
  }
  //   service flows_findAllProposalss

  //appendnew_flow_findAllProposalss_start
  ...
  //appendnew_flow_findAllProposalss_Catch
}
