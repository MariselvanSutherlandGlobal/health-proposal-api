...
export class createProposals {
  ...
  private constructor(
    ...
    this.serviceName = 'createProposals';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_createProposals_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createProposals');
    //appendnew_flow_createProposals_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createProposals');

    this.app['post'](
      `${this.serviceBasePath}/dm/proposals/proposals/create`,
      cookieParser(),
    ...
    //appendnew_flow_createProposals_HttpIn
  }
  //   service flows_createProposals

  //appendnew_flow_createProposals_start
  ...
  //appendnew_flow_createProposals_Catch
}
