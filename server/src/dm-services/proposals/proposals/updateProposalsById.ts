...
export class updateProposalsById {
  ...
  private constructor(
    ...
    this.serviceName = 'updateProposalsById';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new updateProposalsById(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_updateProposalsById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: updateProposalsById');
    //appendnew_flow_updateProposalsById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: updateProposalsById');

    this.app['post'](
      `${this.serviceBasePath}/dm/proposals/proposals/update-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_updateProposalsById_HttpIn
  }
  //   service flows_updateProposalsById

  //appendnew_flow_updateProposalsById_start
  ...
  //appendnew_flow_updateProposalsById_Catch
}
