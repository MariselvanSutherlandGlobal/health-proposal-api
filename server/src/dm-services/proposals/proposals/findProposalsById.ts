...
export class findProposalsById {
  ...
  private constructor(
    ...
    this.serviceName = 'findProposalsById';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new findProposalsById(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_findProposalsById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findProposalsById');
    //appendnew_flow_findProposalsById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findProposalsById');

    this.app['post'](
      `${this.serviceBasePath}/dm/proposals/proposals/find-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_findProposalsById_HttpIn
  }
  //   service flows_findProposalsById

  //appendnew_flow_findProposalsById_start
  ...
  //appendnew_flow_findProposalsById_Catch
}
