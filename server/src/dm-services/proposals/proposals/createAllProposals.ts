...
export class createAllProposals {
  ...
  private constructor(
    ...
    this.serviceName = 'createAllProposals';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new createAllProposals(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_createAllProposals_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createAllProposals');
    //appendnew_flow_createAllProposals_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createAllProposals');

    this.app['post'](
      `${this.serviceBasePath}/dm/proposals/proposals/create-all`,
      cookieParser(),
    ...
    //appendnew_flow_createAllProposals_HttpIn
  }
  //   service flows_createAllProposals

  //appendnew_flow_createAllProposals_start
  ...
  //appendnew_flow_createAllProposals_Catch
}
