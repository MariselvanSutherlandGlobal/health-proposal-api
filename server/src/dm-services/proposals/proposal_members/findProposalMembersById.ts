...
export class findProposalMembersById {
  ...
  private constructor(
    ...
    this.serviceName = 'findProposalMembersById';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new findProposalMembersById(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_findProposalMembersById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug(
      'mounting all middlewares for service :: findProposalMembersById'
    );
    //appendnew_flow_findProposalMembersById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findProposalMembersById');

    this.app['post'](
      `${this.serviceBasePath}/dm/proposals/proposal_members/find-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_findProposalMembersById_HttpIn
  }
  //   service flows_findProposalMembersById

  //appendnew_flow_findProposalMembersById_start
  ...
  //appendnew_flow_findProposalMembersById_Catch
}
